...
function newAddCard() {
  ...
  // const headlining = document.querySelector("#h1");
  // headlining.style.display = "block";
...
//  <button class="done sub-btn"><svg xmlns="http://www.w3.org/2000/svg" class="done" width="1.4em" height="1.4em" viewBox="0 0 24 24"><path fill="currentColor" d="m9.55 18l-5.7-5.7l1.425-1.425L9.55 15.15l9.175-9.175L20.15 7.4L9.55 18Z"></path></svg></button>
...
function addContentToCard() {
  ...
  if (!contentText) {
    ...
    list.innerHTML = `<span>${contentText}</span> <button id="${contentText}" class="done sub-btn-done"><svg xmlns="http://www.w3.org/2000/svg" class="done" width="1.4em" height="1.4em" viewBox="0 0 24 24"><path fill="currentColor" d="m9.55 18l-5.7-5.7l1.425-1.425L9.55 15.15l9.175-9.175L20.15 7.4L9.55 18Z"></path></svg></button>`;
    ...
    list.addEventListener("click", function () {
      if (list.style.textDecoration === "line-through") {
        ...
        document.getElementById(`${contentText}`).style.backgroundColor =
          "transparent";
      } else {
