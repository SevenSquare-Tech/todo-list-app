...
back_btn.addEventListener("click", (arg) => {
  module_13.style.display = "none";
  ...
  document
    .querySelector(".hidden_page_element")
    .classList.remove("hidden_page_element");
});
...
var inp_item = document.querySelector(".input_item");
var item_btn = document.querySelector(".add_button2");
var temp_id;
    ...
    if (inp_item.value == "") {
      ...
      for (let k = 0; k < temp_task.length; k++) {
        if (temp_task[k].classList[1] == temp_id) {
          ...
          p_tag.textContent = inp_item.value;
